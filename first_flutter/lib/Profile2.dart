...
class Profile2Page extends StatefulWidget {
  final UserModel2 showuidClick;
  const Profile2Page(String? uid, {Key? key ,required this.showuidClick}) : super(key: key);

  @override
  State<Profile2Page> createState() => _Profile2State();
}

class _Profile2State extends State<Profile2Page> {
  File? _image;
